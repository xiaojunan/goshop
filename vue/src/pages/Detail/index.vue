      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          <div class="goodsDetail">
            ...
            <p class="news">{{skuInfo.skuName}}</p>
            <div class="priceArea">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttrList,index) in spuSaleAttrList" :key="spuSaleAttrList.id">
                <dt class="title">{{spuSaleAttrList.saleAttrName}}</dt>
                <dd
                  changepirce="0"
                  :class="{active:saleAttrValueName.isChecked==1}"
                  v-for="(saleAttrValueName,index) in spuSaleAttrList.spuSaleAttrValueList"
                  :key="saleAttrValueName.id"
                  @click="changeActive(saleAttrValueName,spuSaleAttrList.spuSaleAttrValueList)"
                >{{saleAttrValueName.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
