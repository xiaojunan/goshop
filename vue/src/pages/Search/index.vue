        ...
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active:isone}" @click="chageOrder(1)">
                  <a>
                    综合
                    <span
                      v-show="isone"
                      class="iconfont"
                      :class="{'icon-up':isasc,'icon-arrowdown':desc}"
                    ></span>
                  </a>
                </li>
                <li :class="{active:istwo}" @click="chageOrder(2)">
                  <a>
                    价格
                    <span
                      v-show="istwo"
...
export default {
  ...
  methods: {
    ...
    removeCategoryName() {
      ...
      this.getData();
      if (this.$router.params) this.$router.push({ name: "search" });
    },
    removeKeyword() {
